...
ip route show
```
**Enable NAT in UFW for wlan1 as well.**<br />
...
**Installing and configuring the Access Point daemon.**<br />
...
**Adding DHCP server settings.**<br />
...
```
<br />
**Assigning a static IP to wlan1, enabling the interface and AP.**<br />
