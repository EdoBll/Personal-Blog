...
<li> **Server Side (Burp Suite ↔ Web Server)**: simultaneously, Burp establishes a separate, independent connection to the actual web server, acting as the client itself.
To enable this decryption and interception, several configurations must be performed.<br />
